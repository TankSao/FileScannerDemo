...
public class FileType {
    ...
    public static boolean isDocs(String fileName){
        if(getFileType(fileName).equals(WORD)){
            return true;
        }else if(getFileType(fileName).equals(PPT)){
            return  true;
        }else if(getFileType(fileName).equals(EXCEL)){
            return  true;
        }else if(getFileType(fileName).equals(PDF)){
            return  true;
        }
        return  false;
    }
